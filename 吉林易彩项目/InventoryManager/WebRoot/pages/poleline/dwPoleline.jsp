...
<script type="text/javascript">
    ...
    function addMarker(){
        for(var i=0;i<markerArr.length;i++){
            ...
            //到注释部分是由朱艳美后添加的-先决条件为该杆路包含的杆路段内起始设施和终止设施都不能为空。
            var Json1=[];
           if(i%2==0){
            	Json1.push(point);
            	Json1.push(new BMap.Point(markerArr[i+1].point.split("|")[0],markerArr[i+1].point.split("|")[1]));
            	var polyline = new BMap.Polyline(Json1, {strokeColor:"red", strokeWeight:1, strokeOpacity:0.9});//在地图上画线
