...
<html>
  <head>
    ...
    <script type="text/javascript" src="js/statistics/statisticReportByUser.js"></script>
  </head>
  <body>
  ...
  <input type="hidden" id="timestart" value="<%=times %>">
  <input type="hidden" id="timeend" value="<%=timee %>">
</body>
</html>
