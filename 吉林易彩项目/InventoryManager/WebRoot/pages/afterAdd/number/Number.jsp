<script type="text/javascript" src="js/base/util/NoWindow.js"></script><%@ page language="java" import="java.util.*" pageEncoding="utf-8"%>
<%
...
<html>
  <head>
	...
	<script type="text/javascript" src="js/afteradd/number/number.js"></script>
