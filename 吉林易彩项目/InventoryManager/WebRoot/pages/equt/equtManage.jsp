    ...
    <body >
    	...
    	Ext.onReady(function(){ 
			...
			var pnWest=new Ext.Panel({
				...
				html:"<iframe id='domainTreeIframe' src='pages/equt/domainTree.jsp' name='domainTree' width='100%' height='100%' frameborder='no' border='0' marginwidth='0' marginheight='0' align='center'></iframe>"	
			});
