...
<html>
  <head>
	...
	<script type="text/javascript" src="js/generator/HighFrequencySwitchingPowerSupply/HFSGrid.js"></script>
	<script type="text/javascript" src="js/generator/HighFrequencySwitchingPowerSupply/seeHFS.js"></script>
	<script type="text/javascript" src="js/generator/util/generatorWindow.js"></script>
