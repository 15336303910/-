...
<html>
	<head>
		...
		<!--本地文件-->
		<script type="text/javascript" src="js/checkGd/resource/resourceIndex.js"></script>
		<script type="text/javascript" src="js/checkGd/resource/editResObject.js"></script>
