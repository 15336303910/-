...
var cm = new Ext.grid.ColumnModel([
   {header : "序号",width : 50,hideable : false,
	...
	com.increase.cen.log.aloneEqut = Ext.extend(Ext.grid.GridPanel, {
		region : 'center',
		id : "aloneEqut",
		border : false,
		cm : cm,// 列定义的model(必需)
		...
		initComponent : function(config) {
			...
			com.increase.cen.log.aloneEqut.superclass.initComponent.call(this);
		}
	});
Ext.reg("aloneEqut", com.increase.cen.log.aloneEqut);