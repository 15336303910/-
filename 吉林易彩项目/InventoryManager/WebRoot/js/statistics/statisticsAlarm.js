...
Ext.onReady(function() {
	...
	var proxy = new Ext.data.HttpProxy({
		url : "statistics!alarmStat.action"
	});
	// Record 定义记录结果
	...
	refreshBtn.on('click', function() {
		...
		location.href="statistics!exportalarms.action?eid="+eid+"&code="+code+"&start="+start+"&limit="+limit+"&begintime="+alarmTimeb+"&endtime="+alarmTimee;
		grid.getView().refresh();		
		/*Ext.getCmp("ename_sel").setValue("");
		Ext.getDom("eid").value="";
		*/
