Ext.onReady(function() {
	...
	//双击查看信息
	var OccGrid=Ext.getCmp("OccGrid");
	OccGrid.on('rowdblclick', function(g, r, e) {
		e.stopEvent();
	...
	seePoint.on('click',function(){
		var OccGrid=Ext.getCmp("OccGrid");
		var selModel = OccGrid.getSelectionModel();// 返回grid的SelectionModel
