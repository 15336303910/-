...
public class ImageUtil {
	 ...
	 * @param imgName
	 */
	public static void SaveStringAsImage(String imgStr, String filePath,
			String imgName) {
		...
		try {
			...
			for (int i = 0; i < b.length; ++i) {
				if (b[i] < 0) {
					int tmp33_31 = i;
					byte[] tmp33_29 = b;
					tmp33_29[tmp33_31] = (byte) (tmp33_29[tmp33_31] + 256);
				}
			}
	...
	public static void download(String urlString, String path,String filename) throws Exception {
	    ...
	    // 读取到的数据长度
	    int len;
	    File saveFileUploadFile = new File(path);
        if (!(saveFileUploadFile.exists())) {
          saveFileUploadFile.mkdirs();
        }
	    // 输出的文件流
	...
	public static void main(String[] args) throws Exception {
	    /*download("https://www.baidu.com/img/bd_logo1.png", "d:\\bd.png");*/
		// 1-缩放图像：
        // 方法一：按比例缩放
