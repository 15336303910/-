...
public class BuriedInfoObj implements Serializable{
	...
	private String buriedModelStr;//维护方式中文
	...
	private String serviceLevel;//业务级别
	private int start;
	private int limit;
	...
	public String getBuriedModelStr() {
		return buriedModelStr;
	}
	public void setBuriedModelStr(String buriedModelStr) {
		this.buriedModelStr = buriedModelStr;
	}
}
