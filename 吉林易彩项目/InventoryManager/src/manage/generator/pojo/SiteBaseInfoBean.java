...
public class SiteBaseInfoBean{
	...
	private BigDecimal city_id;//市
	private BigDecimal county_id;//县区
	...
	private BigDecimal site_longitude;//基站经度
	private BigDecimal site_latitude;//基站纬度
	private BigDecimal ant_azimuth;//天线方向角（度）
	private BigDecimal an_advanceangle;//预置下倾角（度）
	...
	private BigDecimal stateflag;//删除标识
	...
	private List<SiteBaseInfoBean> siteList;
	...
	public List<SiteBaseInfoBean> getSiteList() {
		return siteList;
	}
	public void setSiteList(List<SiteBaseInfoBean> siteList) {
	...
	public void setIs_wrong(Integer is_wrong) {
	...
	public BigDecimal getSite_longitude() {
		return site_longitude;
	}

	public void setSite_longitude(BigDecimal site_longitude) {
		this.site_longitude = site_longitude;
	}

	public BigDecimal getSite_latitude() {
		return site_latitude;
	}

	public void setSite_latitude(BigDecimal site_latitude) {
	...
	public BigDecimal getAn_advanceangle() {
		return an_advanceangle;
	}

	public void setAn_advanceangle(BigDecimal an_advanceangle) {
