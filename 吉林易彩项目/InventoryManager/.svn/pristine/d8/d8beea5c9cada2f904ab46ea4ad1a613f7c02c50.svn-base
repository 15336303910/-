...
<html>
  <head>
	...
	<script type="text/javascript" src="js/equt/occ/occEqutManageGrid.js"></script>
	<script type="text/javascript" src="js/equt/seeEqut.js"></script>
	<script type="text/javascript" src="js/equt/seePoint.js"></script>
	...
	<script type="text/javascript" src="js/equt/showPointGrid.js"></script>
