...
<html>
     <head>
		...
		<script type="text/javascript" src="js/domain/addDomainFormPanel.js"></script>
		<script type="text/javascript" src="js/domain/modifyDomainFormPanel.js"></script>
		<script type="text/javascript" src="js/domain/delDomainFormPanel.js"></script>
		<script type="text/javascript" src="js/domain/domainWindow.js"></script>
    </head>
    <body >
    	...
    	Ext.onReady(function(){ 
			...
			var pnWest=new Ext.Panel({
				...
				html:"<iframe id='domainTreeIframe' src='pages/domain/domainTree.jsp' name='domainTree' width='100%' height='100%' frameborder='no' border='0' marginwidth='0' marginheight='0' align='center'></iframe>"	
			});
			...
			var pnSouth=new Ext.Panel({
				...
				height:20,
				bodyStyle:'border-width:1px 1px 1px 1px',
				html:'<div align="center"><font size="0.8">版权所有：浪潮通信信息系统有限公司</font></div>'
			});
			new Ext.Viewport({
			id:'view',
			layout:"border",
