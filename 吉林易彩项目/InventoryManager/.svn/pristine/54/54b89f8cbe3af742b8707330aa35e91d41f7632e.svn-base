...
//			pls.push(creatContainer(creatPl_AB("MODGAP")));
	...
	var modFrame = {
		html:"<img width='30px' height='10px' src='imgs/point/terminalPanel_event/frame.png'>"
	}
	var modFrame_s = {
		html:"<img width='30px' height='10px' src='imgs/point/terminalPanel_event/frame.png'>"
	}
	var modCorner = {
		html:"<img width='10px' height='10px' src='imgs/point/terminalPanel_event/frame.png'>"
	}
	var modCorner_left = {
		html:"<img width='40px' height='10px' src='imgs/point/terminalPanel_event/frame.png'>"
	}
	var modSide = {
		//html:"<div style=backgroud-img('imgs/point/terminalPanel_event/head.png') >1</div>"
		//html:"<table><tr><td style=backgroud-img('imgs/point/terminalPanel_event/head.png')> 文字</td></tr></table>"
		html:"<img width='10px' height='29px' src='imgs/point/terminalPanel_event/frame.png'>"
	}
	...
	var modSide_left = {
		...
		"<img src='imgs/point/terminalPanel_event/frame.png' width='60' height='29' alt=''> "+
		"<span style='color: silver; font-size: larger; font-weight:bold; position: absolute; top: 0; left: 0;'>77</span>"+
		"</div> "
	}
	var plGap = {
		html:"<img width='30px' height='3px' src='imgs/point/terminalPanel_event/frame.png'>"
	}
	var plGap_s = {
		html:"<img width='3px' height='29px' src='imgs/point/terminalPanel_event/frame.png'>"
	}
	var plGapSide = {
		html:"<img width='10px' height='3px' src='imgs/point/terminalPanel_event/frame.png'>"
	}
	var plGapSide_s = {
		html:"<img width='3px' height='10px' src='imgs/point/terminalPanel_event/frame.png'>"
	}
	var plGapSide_left = {
		html:"<img width='10px' height='3px' src='imgs/point/terminalPanel_event/frame.png'>"
	}
	var plGapSide_left_Gap = {
		html:"<img width='20px' height='3px' src='imgs/point/terminalPanel_event/gap.png'>"
	}
	var modGap = {
		html:"<img width='30px' height='10px' src='imgs/point/terminalPanel_event/gap.png'>"
	}
	var modGap_s = {
		html:"<img width='30px' height='10px' src='imgs/point/terminalPanel_event/gap.png'>"
	}
	var modGap_s_12 = {
		html:"<img width='30px' height='20px' src='imgs/point/terminalPanel_event/gap.png'>"
	}
	var modFrame_s_12 = {
		html:"<img width='30px' height='10px' src='imgs/point/terminalPanel_event/gap.png'>"
	}
	var modGap_s_1 = {
		html:"<img width='3px' height='10px' src='imgs/point/terminalPanel_event/gap.png'>"
	}
	var modGap_s_1_12 = {
		html:"<img width='3px' height='20px' src='imgs/point/terminalPanel_event/gap.png'>"
	}
	var modGapSide_12 = {
		html:"<img width='10px' height='20px' src='imgs/point/terminalPanel_event/frame.png'>"
	}
	var modGapSide = {
		html:"<img width='10px' height='10px' src='imgs/point/terminalPanel_event/frame.png'>"
	}
	...
	var EmptyTerminal = {
		html:"<img width='30px' height='29px' src='imgs/point/terminalPanel_event/duanzi_gray.png'>"
	}
	var EmptyTerminal_s = {
		html:"<img width='29px' height='30px' src='imgs/point/terminalPanel_event/s_duanzi_gray.png'>"
	}
	...
	function createModSideLeft_s(index){//ODF_D2_10_12_720 显示端子
		...
		"<img src='imgs/point/terminalPanel_event/frame.png' width='10' height='29' alt=''> "+
	...
	function createModNoArea(index){//正常设备显示框号
		var ModNoArea = {
			...
			"<img width='30px' height='29px' src='imgs/point/terminalPanel_event/gap.png' alt=''> "+
			"<span style='color: #5599FF; font-size: 20%; font-weight:bold; position: absolute; top: 0; left: 5;'>"+index+"</span>"+
			"</div> "
		}
		return ModNoArea;
	}
	...
	function createFrame_s(index){//ODF_D2_10_12_720 显示盘
		...
		"<img width='30px' height='10px' src='imgs/point/terminalPanel_event/frame.png' alt=''> "+
	...
	function createSideLeft(index){
		var left = {
			html : "<div style='position: relative; width: 10px; height: 29px;'> "+
			"<img src='imgs/point/terminalPanel_event/frame.png' width='10' height='29' alt=''> "+
			"<span style='color: silver; font-size: 10%; font-weight:bold; position: absolute; top: 0; left: 0;'>"+index+"</span>"+
			"</div> "
		}
		return left;
	}
	...
	function createModFrameUp(index){
		var up = {
			html:"<div style='position: relative; width: 30px; height: 10px;'> "+
				"<img src='imgs/point/terminalPanel_event/frame.png' width='30' height='10' alt=''> "+
				"<span style='color: silver; font-size: 10%; font-weight:bold; position: absolute; top: 0; left: 10;'>"+index+"</span>"+
				"</div> "
		}
		return up;
	}//
	...
	function creatTerminal(point){
		var terminal = {
			html : "<input type='hidden' id='s"+point.pid+"' value='"+point.eventstate+"'>"+"<img id='t" + point.pid + "' width='30px' height='29px' src='imgs/point/terminalPanel_event/duanzi_" + point.eventstate + ".png' onclick=showPointInfo('"+point.pid+"')>"
	...
	function creatTerminal_s(point){
		var terminal = {
			html : "<input type='hidden' id='s"+point.pid+"' value='"+point.eventstate+"'>"+"<img id='t" + point.pid + "' width='30px' height='29px' src='imgs/point/terminalPanel_event/s_duanzi_" + point.eventstate + ".png' onclick=showPointInfo('"+point.pid+"')>"
	...
	function creatEmptyTerminal_s(){
		var terminal = {
			html : "<input type='hidden' >"+"<img  width='30px' height='29px' src='imgs/point/terminalPanel_event/s_duanzi_gray.png' >"
		};
		return terminal;
	}
	function creatPanelAlarmArea(modNo, frameNo, canOut){
		...
		var plAlarmArae = {
			html:"<input type='hidden' id='s"+plNo+"' value='0'>"
				...
				+"<img id='c" + plNo + "' width='69px' height='29px'  class='box "+className+"' src='imgs/point/terminalPanel_event/"+img+".jpg' style='display:none' onclick=changeImg('c"+plNo+"')>"
				+"<img id='t" + plNo + "' width='30px' height='29px' src='imgs/point/terminalPanel_event/plalarm_0.png'>"
		}
		return plAlarmArae;
	}
...
function changeImg(id){
	...
	if(or_src.indexOf("on.jpg") != -1){
		Ext.getDom(id).src = 'imgs/point/terminalPanel_event/off.jpg';
	}else if(or_src.indexOf("off.jpg") != -1){
		Ext.getDom(id).src = 'imgs/point/terminalPanel_event/on.jpg';
	}
}

function setFocus(pid){
	focusPid = pid;
	Ext.get("t"+pid).dom.src = "imgs/point/terminalPanel_event/duanzi_selected.png";
}

function focusCancel(pid){
	var state = Ext.getDom("s" + pid).value;
	Ext.getDom("t" + alarm.pid).src = "imgs/point/terminalPanel_event/duanzi_"+ state +".png";
}
...
//				oldImgPath = oldImgPath.substring(oldImgPath.lastIndexOf('_')+1);
				...
				Ext.getDom("t" + alarm.pid).src = "imgs/point/terminalPanel_event/duanzi_"+ alarm.state +".png";
				//setFocus(alarm.pid)
			}else if(parseInt(alarm.type)==1){
				$("#t"+alarm.pid).unbind("click");
				Ext.getDom("t" + alarm.pid).src = "imgs/point/terminalPanel_event/plalarm_"+ alarm.state +".png";
				if(alarm.state != "0" && alarm.state != "1"){
					...
					if(onAndOffImg.indexOf("on.jpg") != -1){
						Ext.getDom("c" + alarm.pid).src = "imgs/point/terminalPanel_event/on_disable.jpg";
					}
					if(onAndOffImg.indexOf("off.jpg") != -1){
						Ext.getDom("c" + alarm.pid).src = "imgs/point/terminalPanel_event/off_disable.jpg";
					}
...
function changPointState(state){
	oldPointImg = "imgs/point/terminalPanel_event/duanzi_"+state+".png";
}
