...
public class WellCustomInfoBean implements Serializable,Cloneable{
	private static final long serialVersionUID = 4748343946928224446L;
	
	private String zh_label;//人手井名称
	private Integer city_id;//地市
	private Integer county_id;//区县
	private String well_kind;//人手井类型
	private String well_type;//人手井具体类型	
	...
	private String transfer_level;//传输级别
	...
	private List<WellCustomInfoBean> wellList;
	
	public Object clone(){
		Object o = null;
		try{
			o = (WellCustomInfoBean)super.clone();
		}catch(Exception e){
			e.printStackTrace();
		}
		return o;
	...
	public String getWell_kind() {
		return well_kind;
	}

	public void setWell_kind(String well_kind) {
		this.well_kind = well_kind;
	}
	...
	public String getTransfer_level() {
		return transfer_level;
	}

	public void setTransfer_level(String transfer_level) {
		this.transfer_level = transfer_level;
	}
	...
	public List<WellCustomInfoBean> getWellList() {
		return wellList;
	}

	public void setWellList(List<WellCustomInfoBean> wellList) {
