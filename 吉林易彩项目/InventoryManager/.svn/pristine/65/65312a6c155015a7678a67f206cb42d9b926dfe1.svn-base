...
String polename = URLDecoder.decode((String)request.getParameter("polename"),"utf-8");
 %>
...
<body>
  ...
  <input id="polename" type="hidden" value=<%=polename %> />
</body>
<script type="text/javascript" >
    //创建和初始化地图函数：
    function initMap(){
    ...
    var contentStr = "<table>"+
						"<tr><td>电杆地址：</td><td>"+addr+"</td></tr>"+
						"<tr><td>电杆名称：</td><td>"+polename+"</td></tr>"+
						"</table>"
