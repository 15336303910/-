 ...
 * @ptype rowexpander
 */
Ext.ux.grid.OrderRowExpander = Ext.extend( Ext.util.Observable, {
	...
	constructor: function( config){
        ...
        Ext.ux.grid.OrderRowExpander.superclass.constructor.call(this);
    ...
    // @private
    onRender: function(record, rowIndex, p, ds) {
        var grid = this.grid;
...
Ext.preg( 'rowexpander', Ext.ux.grid.OrderRowExpander);

//backwards compatibility
Ext.grid.OrderRowExpander = Ext.ux.grid.OrderRowExpander;