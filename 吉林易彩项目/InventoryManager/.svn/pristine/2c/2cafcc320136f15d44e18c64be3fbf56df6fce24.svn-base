...
<html>
  <head>
	...
	<script type="text/javascript" src="js/generator/station/stationManageGrid.js"></script>
	<script type="text/javascript" src="js/generator/station/seeStation.js"></script>
