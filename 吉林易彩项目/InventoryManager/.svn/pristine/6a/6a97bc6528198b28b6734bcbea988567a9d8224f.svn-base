...
<html>
  <head>
	...
	<script type="text/javascript" src="js/property/util/propertyWindow.js"></script>
	<script type="text/javascript" src="js/property/seeProperty.js"></script>
	<script type="text/javascript" src="js/property/propertyInfoGrid.js"></script>
