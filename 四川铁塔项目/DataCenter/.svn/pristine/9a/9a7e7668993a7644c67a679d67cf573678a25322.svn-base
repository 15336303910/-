	...
	<head>
		...
		<script type="text/javascript">
			...
			function flushRegionSelect(cityName){
				if(cityName=="-"){
					...
					$.ajax({ 
						...
						dataType:"JSON",
						data:"typeCode=2&cityName="+cityName,
						async:false,
			...
			$(document).ready(function(){
				...
				oTable = $("#dataTable").dataTable({
					...
					"sAjaxSource":"${pageContext.request.contextPath}/dealExtentDetail/findDatas.ilf"
				});
			});
			function searchData(){
  	...
  	<body style="width:100%;border:solid 1px #FFF;" id="bodyHeight">
		...
		<div class="panel panel-default" style="margin-top:-20px;height:484px;border:solid 1px #FFF;" id="mainPanel">
			<div class="panel-heading" id="panelHeading">>> 场租续签数明细
							...
							<table cellpadding="0" cellspacing="0" border="0" id="dataTable" style="border:0px;">
								<thead>
									<tr>
										...
										<th style="text-align:center;">合同性质</th>
									</tr>
								</thead>
								<tbody></tbody>
							</table>							
