...
<html>
	<head>
		...
		var risk_type='<%=request.getParameter("risk_type")%>';
		risk_name=decodeURI(risk_name);	
		risk_type=decodeURI(risk_type);
		$(document).ready(function(){
				$("#title").html("数据详情--"+risk_type);
				$.ajax({
		...
		<div class="panel panel-primary"  id="mainPanel">
			...
			<div id="panelHeading" style="width:100%;height:50px;background-color:#337ab7;display:table;padding-left:10px">
				<div style="background-color:#337ab7;display:table-cell;vertical-align:middle;padding-left:10px">
					<font id="title" color="white" size="5">数据列表详情--资金问题</font>
				</div>
			</div>
			...
			<div class="panel-body" style="text-align:center;">
				...
				<table id="income_1" style="display:none;width:80%;">
					...
					<tr height="50px">
						<td style="vertical-align:middle;"><span>原因说明：</span></td>
						<td colspan="3"><textarea rows="4" cols="40" id="i1_reason"></textarea></td>
					</tr>
					<tr height="50px">
						<td colspan="4" style="text-align:center;vertical-align:middle;">
							<button type="button" class="btn btn-success" style="width:70px;" onclick="save_data('i1')">保存</button>
				...
				<table id="income_2" style="display:none;width:80%;">
					...
					<tr height="50px">
						<td style="vertical-align:middle;"><span>原因说明：</span></td>
						<td colspan="3"><textarea rows="4" cols="40" id="i2_reason"></textarea></td>
					</tr>
					<tr height="50px">
						<td colspan="4" style="text-align:center;vertical-align:middle;">
							<button type="button" class="btn btn-success" style="width:70px;" onclick="save_data('i2')">保存</button>
				...
				<table id="project_1" style="display:none;width:80%;">
					...
					<tr height="50px">
						<td style="vertical-align:middle;"><span>原因说明：</span></td>
						<td colspan="3"><textarea rows="4" cols="40" id="p1_reason"></textarea></td>
					</tr>
					<tr height="50px">
						<td colspan="4" style="text-align:center;vertical-align:middle;">
							<button type="button" class="btn btn-success" style="width:70px;" onclick="save_data('p1')">保存</button>
				...
				<table id="project_2" style="display:none;width:80%;">
					...
					<tr height="50px">
						<td style="vertical-align:middle;"><span>原因说明：</span></td>
						<td colspan="3"><textarea rows="4" cols="40" id="p2_reason"></textarea></td>
					</tr>
					<tr height="50px">
						<td colspan="4" style="text-align:center;vertical-align:middle;">
							<button type="button" class="btn btn-success" style="width:70px;" onclick="save_data('p2')">保存</button>
						</td>
					</tr>
				</table>
				...
				<table id="project_3" style="display:none;width:80%;">
					...
					<tr height="50px">
						<td style="vertical-align:middle;"><span>原因说明：</span></td>
						<td colspan="3"><textarea rows="4" cols="40" id="p3_reason"></textarea></td>
					</tr>
					<tr height="50px">
						<td colspan="4" style="text-align:center;vertical-align:middle;">
							<button type="button" class="btn btn-success" style="width:70px;" onclick="save_data('p3')">保存</button>
				...
				<table id="project_4" style="display:none;width:80%;">
					...
					<tr height="50px">
						<td style="vertical-align:middle;"><span>原因说明：</span></td>
						<td colspan="3"><textarea rows="4" cols="40" id="p4_reason"></textarea></td>
					</tr>
					<tr height="50px">
						<td colspan="4" style="text-align:center;vertical-align:middle;">
							<button type="button" class="btn btn-success" style="width:70px;" onclick="save_data('p4')">保存</button>
				...
				<table id="station_1" style="display:none;width:80%;">
					...
					<tr height="50px">
						<td style="vertical-align:middle;"><span>原因说明：</span></td>
						<td colspan="3"><textarea rows="4" cols="40" id="s1_reason"></textarea></td>
					</tr>
					<tr height="50px">
						<td colspan="4" style="text-align:center;vertical-align:middle;">
							<button type="button" class="btn btn-success" style="width:70px;" onclick="save_data('s1')">保存</button>
				...
				<table id="station_2" style="display:none;width:80%;">
					...
					<tr height="50px">
						<td style="vertical-align:middle;"><span>原因说明：</span></td>
						<td colspan="3"><textarea rows="4" cols="40" id="s2_reason"></textarea></td>
					</tr>
					<tr height="50px">
						<td colspan="4" style="text-align:center;vertical-align:middle;">
							<button type="button" class="btn btn-success" style="width:70px;" onclick="save_data('s2')">保存</button>
				...
				<table id="colocation_1" style="display:none;width:80%;">
					...
					<tr height="50px">
						<td style="vertical-align:middle;"><span>原因说明：</span></td>
						<td colspan="3"><textarea rows="4" cols="40" id="c1_reason"></textarea></td>
					</tr>
					<tr height="50px">
						<td colspan="4" style="text-align:center;vertical-align:middle;">
							<button type="button" class="btn btn-success" style="width:70px;" onclick="save_data('c1')">保存</button>
				...
				<table id="colocation_2" style="display:none;width:80%;">
					...
					<tr height="50px">
						<td style="vertical-align:middle;"><span>原因说明：</span></td>
						<td colspan="3"><textarea rows="4" cols="40" id="c2_reason"></textarea></td>
					</tr>
					<tr height="50px">
						<td colspan="4" style="text-align:center;vertical-align:middle;">
							<button type="button" class="btn btn-success" style="width:70px;" onclick="save_data('c2')">保存</button>
						</td>
					</tr>
				</table>
			</div>
