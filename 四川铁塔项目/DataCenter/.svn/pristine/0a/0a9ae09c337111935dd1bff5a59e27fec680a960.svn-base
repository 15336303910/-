	...
	<head>
		...
		<script type="text/javascript">
			function bindingKeyDown(){
				$("#classNameKey").bind("keydown",function(event){
					if(event.keyCode==13){
						doSearchClass();
						return false;
					}
						...
						if(textStatus["success"]){
							...
							if(items!=null && items.length>0){
								for(var i=0;i<items.length;i++){
									...
									buckHtml+="					<img src='${pageContext.request.contextPath}/img/icon/codeblocks.ico' style='height:20px;width:20px;margin-left:15px;display:none;'></img>";
									buckHtml+="					<a onclick='javascript:turnToTeamShow();' style='margin-left:3px;cursor:pointer;display:none;'>分组总览</a>";
									buckHtml+="				</div>";
									buckHtml+="			</div>";
									buckHtml+="    </div>";
									buckHtml+="</div>";								
  	...
  	<body style="width:100%;border:solid 1px #FFF;" id="bodyHeight">
		...
		<div class="panel panel-default" style="height:780px;border:solid 1px #FFF;" class="models" id="mainPanel">
			<div class="panel-heading" id="panelHeading">
				...
				<form class="form-search pull-right">	
					<div style="float:right;">
						<input class="buckResearch" type="text" placeholder="请输入规则分类名称进行查询" style="width:200px;border-radius:6px;height:29px;font-size:12px;border:solid 1px #A3D0E3;" id="classNameKey"></input>
						<img class="buckResearch" src="${pageContext.request.contextPath}/img/icon/icon-Search.png" style='height:22px;width:22px;cursor:pointer;margin-left:5px;' onclick="javascript:doSearchClass();"></img>
						<a class="btn btn-warning" style="cursor:pointer;margin-left:10px;" onclick="javascript:showOrHide(1);">
			...
			<%--规则视图--%>
			<div class="panel-body" style="width:100%;border:0px;display:none;" id="ruleConfigDiv">
				<div style="width:99.8%;overflow:auto;border:solid 1px #FFF;" id="ruleEditsBuck">
					...
					<div style="float:left;width:71%;margin-top:4px;margin-left:4px;" id="rightDataPanel">
						<div class="panel-heading" style="border:solid 1px #A3D0E3;border-bottom:0px;" id="ruleTablePanel">
							<span class="panel-label"></span>规则管理
							<form class="form-search pull-right">	
								<div style="float:right;">
									...
									<a class="btn btn-warning" style="cursor:pointer" onclick="javascript:auditRightNow();">
										<i class="icon-play-circle icon-white"></i>立即执行
									</a>
									<a class="btn btn-success" style="cursor:pointer" onclick="javascript:turnToPage();" >
										<i class="icon-plus-sign icon-white"></i>规则配置
									</a>
									<a class="btn btn-inverse" style="cursor:pointer" onclick="javascript:turnToSqlPage();" >
										<i class="icon-file icon-white"></i>自定义SQL配置
									</a>
									<a class="btn btn-info" style="cursor:pointer" onclick="javascript:turnToLineChart();">
										<i class="icon-signal icon-white"></i>历史分析
									</a>
									<a class="btn btn-danger"  style="cursor:pointer" onclick="javascript:deleteRule();">
			...
			<%--任务视图--%>
			<div class="panel-body" style="border:0px;" id="ruleShowDiv">
