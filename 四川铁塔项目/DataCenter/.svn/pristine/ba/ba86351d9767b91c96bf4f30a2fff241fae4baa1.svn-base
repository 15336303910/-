	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$.get("${pageContext.request.contextPath}/extensions/echarts/EchartsMap/mapdata/geometryCouties/guang_an.json",function(mapJson){
					echarts.registerMap("广安",mapJson);
