		...
		<script type="text/javascript">
			...
			function manageUploads(){
				...
				if(checkedValue!=null){
					window.parent.turnToJsp("项目资料上传","jsp/project/fileUpload.jsp?projectCode="+checkedValue);
				}else{
					window.wxc.xcConfirm("请先选择一个项目工程.",window.wxc.xcConfirm.typeEnum.info);
				}
			}
		</script>
  	</head>
  	<body style="width:99.8%;border:solid 1px #FFF;" id="bodyHeight">
		...
		<div class="panel panel-default" style="margin-top:-20px;height:485px;border:solid 0px #FFF;" id="mainPanel">
			<div class="panel-heading" id="panelHeading" style="border:solid 1px #A3D0E3;border-bottom:0px;">
				...
				<span class="panel-label"></span>项目管理 >> 工程资料管理
				<form class="form-search pull-right">	
					<div style="float:right;">
						...
						<a class="btn btn-warning" style="cursor:pointer" onclick="javascript:manageUploads();">
							<i class="icon-lock icon-white"></i>项目附件/资料管理
						</a>
						<a class="btn btn-inverse" style="cursor:pointer">
							<i class="icon-refresh icon-white"></i>生成文档
						</a>	
					</div>
				</form>
			</div>
							...
							<table cellpadding="0" cellspacing="0" border="0" id="dataTable">
								<thead>
									<tr>
										...
										<th style="text-align:center;">站点编码</th>
