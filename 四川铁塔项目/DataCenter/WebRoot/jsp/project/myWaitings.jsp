		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				oTable = $("#dataTable").dataTable({
					...
					"sAjaxSource":"${pageContext.request.contextPath}/projectCheckinAction/findMyWaitings.ilf"
				});
			});
			function searchData(){
			...
			function startCheckJob(){
				...
				if(checkedValue!=null){
					window.wxc.xcConfirm("是否刷新待办任务列表？","custom",{
						title:"提示",
						btn:parseInt("0011",2),
						onOk:function(){
							oTable.fnDraw();
					...
					window.parent.turnToJsp("外验交付审核","jsp/project/edit/auditJob.jsp?prjId="+checkedValue);
				}else{
  	...
  	<body style="width:99.8%;border:solid 1px #FFF;" id="bodyHeight">
		...
		<div class="panel panel-default" style="margin-top:-20px;height:485px;border:solid 0px #FFF;" id="mainPanel">
			<div class="panel-heading" id="panelHeading" style="border:solid 1px #A3D0E3;border-bottom:0px;">
				...
				<span class="panel-label"></span>项目管理 >> 我的项目外验待办任务
				<form class="form-search pull-right">	
					<div style="float:right;">
						...
						<a class="btn btn-success" style="cursor:pointer" onclick="javascript:startCheckJob();">
							<i class="icon-flag icon-white"></i>外验审批
						</a>
					</div>
				</form>
			</div>
