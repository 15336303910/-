		...
		<script type="text/javascript">
		 ...
		 var conditions = [];
			$(document).ready(function(){
				...
				/*显示全省工程类问题总数、反馈数、反馈率*/
				$.ajax({
					url:"${pageContext.request.contextPath}/EngineeringTypeAmountAction/findEngineeringFeedbackSumData.ilf", 
					async:true,
					type:"POST",
					dataType:"json",
				...
				var pageNumbers = parseInt(tableHeight/26);
					...
					"sAjaxSource":"${pageContext.request.contextPath}/EngineeringTypeAmountAction/findEngineeringTypeDatas.ilf",	 
							 "oLanguage" : { // 国际化配置
			...
			function searchData(){
				...
				/*查询地级市工程类问题总数、反馈数、反馈率*/
				$.ajax({
					url:"${pageContext.request.contextPath}/EngineeringTypeAmountAction/findEngineeringTypeFeedbackNumData.ilf",
					async:true,
					type:"POST",
					dataType:"json",
		...
		<div class="panel panel-primary"  id="mainPanel">
			...
			<div id="panelHeading" style="width:100%;height:50px;background-color:#337ab7;display:table;padding-left:10px">
				<div style="background-color:#337ab7;display:table-cell;vertical-align:middle;padding-left:10px">
					<font color="white" size="5">在线风控--工程类</font>
				</div>
			</div>
