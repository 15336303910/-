		...
		<script type="text/javascript">
		 ...
		 var conditions = [];
			$(document).ready(function(){
				...
				/*显示全省基站电费问题总数、反馈数、反馈率*/
				$.ajax({
					url:"${pageContext.request.contextPath}/BaseStationElectricChargeAction/findBaseStationFeedbackSumData.ilf", 
					async:true,
					type:"POST",
					dataType:"json",
				...
				var pageNumbers = parseInt(tableHeight/26);
					oTable = $("#dataTable").dataTable({
						...
						"sAjaxSource":"${pageContext.request.contextPath}/BaseStationElectricChargeAction/findBaseStationElectricChargeDatas.ilf",
							 "oLanguage" : { // 国际化配置
			...
			function searchData(){
				...
				/*查询地级市基站电费问题总数、反馈数、反馈率*/
				$.ajax({
					url:"${pageContext.request.contextPath}/BaseStationElectricChargeAction/findBaseStationFeedbackNumData.ilf",
					async:true,
					type:"POST",
					dataType:"json",
		...
		<div class="panel panel-primary"  id="mainPanel">
			...
			<div id="panelHeading" style="width:100%;height:50px;background-color:#337ab7;display:table;padding-left:10px">
				<div style="background-color:#337ab7;display:table-cell;vertical-align:middle;padding-left:10px">
					<font color="white" size="5">在线风控--基站电费</font>
				</div>
			</div>
