		...
		<script type="text/javascript">
		 ...
		 var conditions = [];
			$(document).ready(function(){
				...
				/*显示全省资金问题总数、反馈数、反馈率*/
				$.ajax({
					url:"${pageContext.request.contextPath}/FundQuestionAmountAction/findFundQuestionAmountSumData.ilf", 
					async:true,
					type:"POST",
					dataType:"json",
				...
				var pageNumbers = parseInt(tableHeight/26);
					oTable = $("#dataTable").dataTable({
						...
						"sAjaxSource":"${pageContext.request.contextPath}/FundQuestionAmountAction/findFundQuestionAmountDatas.ilf",
							 "oLanguage" : { // 国际化配置
			...
			function searchData(){
				...
				/*查询地级市资金问题总数、反馈数、反馈率*/
				$.ajax({
					url:"${pageContext.request.contextPath}/FundQuestionAmountAction/findFundQuestionAmountNumData.ilf",
					async:true,
					type:"POST",
					dataType:"json",
		...
		<div class="panel panel-primary"  id="mainPanel">
			...
			<div id="panelHeading" style="width:100%;height:50px;background-color:#337ab7;display:table;padding-left:10px">
				<div style="background-color:#337ab7;display:table-cell;vertical-align:middle;padding-left:10px">
					<font color="white" size="5">在线风控--资金问题</font>
				</div>
			</div>
				...
				<div style="width:100%;height:50px">
			 	...
			 	<div class="col-xs-12 col-sm-12 col-md-12"
					...
					<div class="col-xs-3 col-sm-3 col-md-3" style="height:40px;">
						<font size="4">资金问题:</font>
						<font size="4" color="red"><span id="qu_totalnum">-</span></font>
						<!--<button type="button" class="btn btn-danger btn-sm" style="width:70px;"><span id="qu_totalnum">-</span></button>-->
					</div>
					<div class="col-xs-3 col-sm-3 col-md-3" style="height:40px;">
						<font size="4">已反馈:</font>
						<font size="4" color="#32CD32"><span id="qu_feedbacknum">-</span></font>
						<!--<button type="button" class="btn btn-success btn-sm" style="width:70px;"><span id="qu_feedbacknum">-</span></button>-->
					</div>
					<div class="col-xs-3 col-sm-3 col-md-3" style="height:40px;">
						<font size="4">反馈率:</font>
						<font size="4" color="#40E0D0"><span id="qu_feedbackpro">-</span></font>
						<!--<button type="button" class="btn btn-info btn-sm" style="width:70px;"><span id="qu_feedbackpro">-</span></button>-->
					</div>
