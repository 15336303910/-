  	...
  	<body style="width:100%;">
		<div class="panel panel-default" style="margin-top:1px;height:480px;">
			<div class="panel-heading">
				<span class="panel-label"></span>我的待办工单
				<form class="form-search pull-right">	
					<div style="float:right;">
						<input type="text" placeholder="专业或资源模型选择" style="width:150px;height:29px;font-size:12px;"></input>
						...
						<a class="btn btn-success" href="#myModal" role="button" data-toggle="modal" style="cursor:pointer">
							<i class="icon-cog icon-white"></i>处理工单
						</a>						
						...
						<a class="btn btn-danger"  style="cursor:pointer">
							<i class="icon-flag icon-white"></i>查看流程图
						</a>	
						<a class="btn btn-inverse"  style="cursor:pointer">
							<i class="icon-film icon-white"></i>处理历史
						</a>	
					</div>
				</form>
			</div>
